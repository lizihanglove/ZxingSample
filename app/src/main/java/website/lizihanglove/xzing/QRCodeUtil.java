...
public class QRCodeUtil {
    ...
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size,
                                            @Nullable String character_set, @Nullable String error_correction, @Nullable int margin,
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, Bitmap logo, Bitmap bg,Float logoPercent) {
        return createQRCodeBitmap(content, size, "UTF-8", "H",4, Color.BLACK, Color.WHITE, logo, bg, logoPercent);
    }
}
